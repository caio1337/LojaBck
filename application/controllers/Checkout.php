...
class Checkout extends CI_Controller{
    ...
    public function index(){
        ...
        //Carrega a API do pagseguro de acordo com valor do ambiente, 1:Sandbox/teste , 2:Ambiente real/Produtivo
        if($config_pagseguro->config_ambiente == 1){

            $api_javascript = 'pagseguro-sandbox.directpayment.js';//Sandbox/Testes
        }else{
            $api_javascript = 'pagseguro-produtivo.directpayment.js';//Real/Produtivo
        }
