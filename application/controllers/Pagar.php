    ...
    public function boleto() {
        ...
        if (!$cliente = $this->core_model->get_by_id('clientes', array('cliente_id' => $cliente_user_id))) {
            ...
            if (!$hash_pagamento) {
                ...
                $pagar_pedido['senderEmail'] = ($config_pagseguro->config_ambiente == 1 ? 'c60691202820409723562@sandbox.pagseguro.com.br' : $email_comprador);
...
//                        'transacao_link_pagamento' => $transaction->paymentLink, //Não há link de pagamento para cartão
    ...
    public function sucesso(){
        ...
        if(!empty($pedido_realizado)){
            //Sucesso, tem dados na variavel

            //Remove o link de pagamento quando for cartao , ou == 1;
