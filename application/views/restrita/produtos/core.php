                ...
                <div class="card">
                  ...
                  <?php endif; ?>
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <div class="form-group col-md-2">
                        <label for="inputState">Controle estoque</label>
                        <select id="" name="produto_controlar_estoque" class="form-control">
                          <?php  if(isset($produto)): ?>
                      ...
                      <div class="form-group col-md-8">
                        ...
                        <textarea class="form-control" name="produto_descricao" rows="6" style="min-height: 100px;"><?php echo (isset($produto)? $produto->produto_descricao : set_value('produto_descricao')); ?></textarea>
                      ...
                      <div class="form-row">
                        <div class="col-md-12">
                          ...
                          <div id="uploaded_image" class="texte-danger" >
