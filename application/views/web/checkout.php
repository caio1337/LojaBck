                                ...
                                <div class="table-content table-responsive">
                                    <table class="table">
                                        ...
                                        <?php foreach ($carrinho as $produto): ?> 
                                            ...
                                            <tr>
                                                <td class="li-product-thumbnail"><a href="<?php echo base_url('produto/' . $produto['produto_meta_link']); ?>"><img width="70" src="<?php echo base_url('uploads/produtos/small/' . $produto['produto_foto']); ?>" alt="<?php echo $produto['produto_nome'] ?>"></a></td>
                    ...
                    <?php if(!$logged_in): ?>
                        ...
                        <div class="row">
                            ...
                            <div class="coupon-accordion">
                                <!--Accordion Start-->
                                <h3>Já é nosso cliente ? <span id="showlogin">Clique aqui para entrar</span></h3>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="checkout-form-list">
                                                    ...
                                                    <input id="cliente_cep" class="cep" type="text" name="cliente_cep" value="<?php set_value('cliente_cep'); ?>" required="">
                                            ...
                                            <div class="col-md-4">
                                                <div class="checkout-form-list">
                                                    ...
                                                    <button class="btn btn-info" id="btn-busca-cep" style="padding: 8.1px 17px; border-radius: 1px; height: 40px; margin: 28px 0 0; font-size: 14px; border-radius: 1px;" type="button">Calcular frete</button>
                                                    </div>
                                                </div>
                                            </div>
