            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        ...
                        <p class="mt-5"><span class="product-details-ref" style="font-size: 16px;">Estoque:&nbsp;<?php echo ($produto->produto_quantidade_estoque > 0 ? '<span class="badge badge-success" style="padding-left: 10px; padding-right: 10px">' . $produto->produto_quantidade_estoque . '</span>' : '<span class="badge badge-danger">Indisponível</span>'); ?></span></p>
