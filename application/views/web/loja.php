                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 text-center pt-xs-30">
                            <div class="li-banner">
                                <a href="#">
                                    <img src="<?php echo base_url('public/web/images/banner/luva.jpg') ?>" alt="">
                                </a>
                            </div>
                            <div class="li-banner mt-15 mt-sm-30 mt-xs-30">
                                <a href="#">
                                    <img src="<?php echo base_url('public/web/images/banner/mascara.jpg') ?>" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="li-product-tab">
                                <ul class="nav li-product-menu">
                                   ...
                                   <li><a data-toggle="tab" href="#li-bestseller-product"><span>Mais vendidos</span></a></li>
                                   <li><a data-toggle="tab" href="#li-featured-product"><span>Produtos destaque</span></a></li>
                                </ul>               
                            </div>
                                ...
                                <div class="product-active owl-carousel">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="<?php echo base_url('public/web/images/product/large-size/nivea.jpg') ?>" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="shop-left-sidebar.html">Cuidados pessoais</a>
                                                        </h5>
                                                        <div class="rating-box">
                                                            <ul class="rating">
                                                                <li><i class="fa fa-star-o"></i></li>
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Nivea Milk 400ml</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price">R$46.80</span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="#">Comprar</a></li>
                                                        <li><a class="links-details" href="wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                                                        <li><a href="#" title="Detalhes" class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-eye"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="<?php echo base_url('public/web/images/product/large-size/alcoolgel.jpg')  ?>" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="shop-left-sidebar.html">Higiene</a>
                                                        </h5>
                                                        <div class="rating-box">
                                                            <ul class="rating">
                                                                <li><i class="fa fa-star-o"></i></li>
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Alcool Gel 500ml</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price">R$30.80</span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="<?php echo base_url('public/web/images/product/large-size/bepantriz.jpg')  ?>" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Bepantriz Pomada</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price">R$6.80</span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="<?php echo base_url('public/web/images/product/large-size/dipirona.jpg')  ?>" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="shop-left-sidebar.html">Dor e febre</a>
                                                        </h5>
                                                        <div class="rating-box">
                                                            <ul class="rating">
                                                                <li><i class="fa fa-star-o"></i></li>
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Dipirona 10cps</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price">R$1.80</span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="<?php echo base_url('public/web/images/product/large-size/dorflex.jpg')  ?>" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Dorflex 10cps</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price">R$4.80</span>
                                                    </div>
                                                </div>
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Alcool Gek 500ml</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price">R$30.80</span>
